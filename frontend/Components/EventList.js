...
export default function EventList() {
    ...
    useEffect(()=>{
        axios.get("http://192.168.120.253:4000/eventData").then((res)=>setdata(res.data))
    },[])
  return (
    <>
        <View style={{backgroundColor:"#404040",height:"15%"}}>
            <View style={{marginTop:"17%"}}>
             <Text style={{color:"white",alignSelf:"center",fontSize:30,fontWeight:'bold'}}>EVENT PHOTOS</Text>
            </View>
        </View>
        <ScrollView>
        {
